      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-lg mx-auto px-6">
        ...
        <div className="flex items-center gap-3 mt-8">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="w-9 h-9 flex items-center justify-center rounded-full border border-white/[0.08] text-white/30 hover:text-pink/70 hover:border-pink/30 transition-all duration-300"
          >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
            className="w-9 h-9 flex items-center justify-center rounded-full border border-white/[0.08] text-white/30 hover:text-sky/70 hover:border-sky/30 transition-all duration-300"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
